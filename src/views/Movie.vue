...
<div v-if="tv">
    <div class="film-grid">
      <div class="film-left">
          ...
          <img v-else class="bg-gray-300 h-full" src="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg" alt="">
      </div>
  ...
  >
    <swiper-slide v-for="recommend in recommends" :key='recommend.id' class='pb-4'>
        <div class="single-recommend">
            <router-link :to="{name:'MovieRecommend',params:{id:recommend.id}}">
